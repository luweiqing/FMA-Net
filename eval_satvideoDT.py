...
string.""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('--result', type=str, help='Log level', default='./ICPR/DLADCN/results/tracking*')
...
if __name__ == '__main__':
    ...
    ts = OrderedDict([(os.path.splitext(Path(f).parts[-1])[0], mm.io.loadtxt(f, cat_id= 1, fmt=args.fmt)) for f in tsfiles])
