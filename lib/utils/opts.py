...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--load_model', default='',  ##./checkpoints/model_15.pth
        ...
        self.parser.add_argument('--seed', type=int, default=317,
                                 help='random seed')  # from CornerNet  3407
        ...
        # tracking
        self.parser.add_argument('--conf_thres', type=float, default=0.2, help='confidence thresh for tracking')
        ...
        #scheduler
        self.parser.add_argument('--scheduler', type=str, default='cos',
                                 help='.')
        self.parser.add_argument('--steps', type= list, default=[15,22],
                                 help='.')
        self.parser.add_argument('--gamma', type=float, default=0.1,
                                 help='.')
        self.parser.add_argument('--warmup', type=str, default= 'linear',
                                 help='.')
        self.parser.add_argument('--warmup_iters', type=int, default= 5000,  #总迭代次数的5%-10%
                                 help='.')
